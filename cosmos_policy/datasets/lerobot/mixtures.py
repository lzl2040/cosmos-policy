...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "ms_complete_data_franka":[
        ...
        ("kuka", 0.3),
        ("bridge_orig", 0.3),                                   # Original Version of Bridge V2 from Project Website
        ("taco_play", 0.3),
        ("jaco_play", 0.3),
        ("roboturk", 0.3),
        ("viola", 0.3),
    ...
    "mini" : [
     ...
     "libero": [
        ...
        ("libero_spatial_no_noops", 1.0), 
        ("libero_10_no_noops", 1.0),
        ("libero_goal_roll_success", 1.0), 
        ("libero_object_roll_success", 1.0), 
        ("libero_spatial_roll_success", 1.0), 
        ("libero_10_roll_success", 1.0),
     ],
     "libero_all": [
        # ("libero_goal_no_noops", 1.0), 
        # ("libero_object_no_noops", 1.0), 
