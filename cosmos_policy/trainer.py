...
class CosmosPolicyTrainer(ImaginaireTrainer):
    ...
    def train(
        ...
        if pretrain_path is not None:
            self.checkpointer.load_with_file(model, optimizer, scheduler, grad_scaler, checkpoint_path=pretrain_path)
            log.critical(f"Loading pretrained weights from {pretrain_path}...")
