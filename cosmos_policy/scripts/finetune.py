...
def launch(config: Config, args: argparse.Namespace) -> None:
    ...
    config.model.config.fsdp_shard_size = 1 # disable fsdp
    with model_init():
    ...
    _state_dict = _model_wrapper.state_dict() # only self.net state_dict
    storage_reader = checkpointer.get_storage_reader(dcp_path)
    ...
    print(f"Successfully loaded weights from {dcp_path}.")
    ...
    # dcp_path = "/home/cosmos/.cache/cosmos_policy/libero/ace_cosmos_0521/checkpoints/iter_000010000"
    dcp_path = None
